...
public:
	enum enLogLevel
	{
		_LOG_INFO = VIS_LOG_INFO,
		_LOG_DEBUG = VIS_LOG_DEBUG,
		_LOG_TRACE = VIS_LOG_TRACE,
		_LOG_ERROR = VIS_LOG_ERROR,
		_LOG_WARN = VIS_LOG_WARN,
		_LOG_FATAL = VIS_LOG_FATAL,
		_LOG_OFF = VIS_LOG_OFF
	};
